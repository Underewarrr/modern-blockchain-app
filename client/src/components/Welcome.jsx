...
function Welcome() {
  const {
    currentAccount, connectWallet, handleChange, sendTransaction, formData, isLoading,
  ...
  return (
    <div className="flex w-full justify-center items-center">
      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-50 py-12 px-4">
        {' '}
        {/* this is a custom class that is used to create a border between the navbar items */}
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
            Explorer the crypto world with the worlds most popular crypto exchange.Easily on Krypt.
          </p>
          {!currentAccount && (
            <button
              type="button"
